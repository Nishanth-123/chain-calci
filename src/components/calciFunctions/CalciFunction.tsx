...
const CalciFunction = ({equation, nextFunction, displayName, id, left: l, top: t}: CalciFunctionProps) => {
    ...
    return <div className={`flex flex-col items-start w-[235px] h-[251px] border-[1px] rounded-[15px] border-solid p-[20px] pt-[15px] absolute border-[#DFDFDF]`} style={{left : `${left}px`, top: `${top}px`}}>
